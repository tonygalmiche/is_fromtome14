...
2. **Coûts d'achat** : avoirs fournisseurs pris en compte (point 1), sauf ceux sans commande (remises de fin d'année… : ligne sans client) ; frais annexes des fournisseurs ignorés (coût sous-estimé). Seules les factures validées sont prises en compte.
